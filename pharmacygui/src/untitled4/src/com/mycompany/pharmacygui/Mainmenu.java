...
public class Mainmenu extends javax.swing.JFrame {
    ...
    public Mainmenu(String capacity, String drugType) {
...
//        String drugType = jComboBox1.getSelectedItem().toString();
//        JOptionPane.showMessageDialog(this, "Login successful. Welcome, " +"!");

        // Pass the capacity and drug type to the menu2 frame
        menu2 menu2 = new menu2();
        menu2.setVisible(true);
        this.dispose(); // Close the current Mainmenu frame
    }
